...
<svelte:head>
	<title>{data.info.nameFull} ({data.info.ticker}) Financial Statements: Income</title>
</svelte:head>

<StockLayout state={{ info: data.info, data }}>
	<FinancialTable statement="income-statement" range="quarterly" title="Income Statement" map={MAP_INCOME_STATEMENT} />
</StockLayout>
