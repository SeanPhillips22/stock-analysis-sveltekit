<script lang="ts" context="module">
	...
	export const load: Load = async ({ params, fetch, stuff }) => {
		...
		let url = `${host}/financials?type=ratios&symbol=${symbol}&range=trailing`
...
<FinancialTable {info} {data} statement="ratios" range="trailing" title="Ratios and Metrics" map={MAP_RATIOS} />
