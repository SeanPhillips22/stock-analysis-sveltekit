<script lang="ts" context="module">
	...
	export const load: Load = async ({ params, fetch, stuff }) => {
		...
		let url = `http://stockanalysis20febr.local/wp-json/sa/financials?type=income-statement&symbol=${symbol}&range=trailing`
...
<FinancialTable {info} {data} statement="income" range="trailing" title="Income Statement" map={MAP_INCOME_STATEMENT} />
